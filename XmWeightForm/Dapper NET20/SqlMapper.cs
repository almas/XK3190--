...
namespace Dapper_NET20
{
	...
	static partial class SqlMapper
	{
        ...
        public static DataSet ExecuteDataSet(this IDbConnection cnn, string sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType)
        {
